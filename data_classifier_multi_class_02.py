...
# test_data_label.extend(ut.data_array_2_data_labels(data_5_array,"class_5"))
# test_data_label.extend(ut.data_array_2_data_labels(data_6_array,"class_6"))
